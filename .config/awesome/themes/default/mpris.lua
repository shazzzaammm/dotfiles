...
local function worker()
	...
	local update_graphic = function(widget, stdout, _, _, _)
		...
		if player_status == "Playing" then
			...
			widget.colors = { beautiful.blue }
			artist_widget.markup = "<span foreground='" .. beautiful.blue .. "'>" .. artist .. "</span>"
			title_widget.markup = "<span foreground='" .. beautiful.blue .. "'>" .. current_song .. "</span>"
		elseif player_status == "Paused" then
			icon.image = PAUSE_ICON_NAME
			widget.colors = { beautiful.light_white }
			artist_widget.markup = "<span foreground='" .. beautiful.light_white .. "'>" .. artist .. "</span>"
			title_widget.markup = "<span foreground='" .. beautiful.light_white .. "'>" .. current_song .. "</span>"
		elseif player_status == "Stopped" then
			icon.image = STOP_ICON_NAME
		else -- no player is running
			icon.image = LIBRARY_ICON_NAME
			widget.colors = { beautiful.grey }
		end
	end
